	...
	<nav id="left-panel">
		<div id="left-panel-content">
			<ul>
				<li>
					<a href="<?php echo base_url(); ?>anggota/ebook"><span class="icon-dashboard"></span>E-Book</a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>anggota/buku"><span class="icon-file-alt"></span>Buku</a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>anggota/peminjaman"><span class="icon-th-large"></span>Peminjaman</a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>anggota/pengembalian"><span class="icon-font"></span>Pengembalian</a>
				</li>
				</li>
			</ul>
		</div>
